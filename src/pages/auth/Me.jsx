...
const Me = () => {
  ...
  useEffect(() => {
    ...
    const fetchAnalytics = async () => {
      try {
        const res = await axios.get("http://localhost:8080/api/expense/summary", {
          headers: {
            "Authorization": `${token}`
          }
        });
      ...
      <div className="max-w-4xl mx-auto py-10 px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-8 bg-white rounded-xl shadow-lg p-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            <button onClick={()=>{navigate("/create-expense")}} className="flex items-center justify-center p-4 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-lg hover:from-blue-700 hover:to-purple-700 transition-colors duration-200">
            ...
            <button
                ...
                className="flex items-center justify-center p-4 bg-red-500 text-white rounded-lg hover:bg-red-600 transition-colors duration-200"
            >
                <svg className="h-5 w-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 16l4-4m0 0l-4-4m4 4H7m6 4v1m0-10V5a2 2 0 00-2-2H5a2 2 0 00-2 2v14a2 2 0 002 2h6a2 2 0 002-2" />
                </svg>
                Logout
            </button>
          </div>
